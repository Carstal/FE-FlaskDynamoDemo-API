    ...
    <div className={styles.container}>
      <main>
        ...
        <div id="visitContainer">
          ...
          <div className="visit">
            <div className="info">
              <div className="vrRow">ID:{student.student_id} GPA: {student.GPA}</div>
              <div className="empRow">First Name: {student.FirstName}</div>
              <div className="startRow">Last Name: {student.LastName}</div>
              <div className="endRow">Major: {student.Major}</div>
            </div>
